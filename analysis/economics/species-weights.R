...
transits <- read.csv(paste0(datapath, "dataCSV/spawn-transits/spawn-transits-rescaled", suffix, ".csv"))

## SAU and Sovereign-level weights
## Generated by country-weights.R
regions <- read.csv(paste0(datapath, "dataCSV/weights/combined-regions-new", weights.suffix, ".csv"))
weights <- read.csv(paste0(datapath, "dataCSV/weights/combined-country", weights.suffix, ".csv"))
...
if (do.figures) {
    ...
    landdists <- read.csv(paste0(datapath, "dataTEXT/landdists.csv"))
...
if (do.figures) {
    ...
    pdf(paste0("../figures/atrisk-value-split", outsuffix, ".pdf"), width=3.5, height=4)
    ...
    pdf(paste0("../figures/atrisk-catch-split", outsuffix, ".pdf"), width=4, height=4)
    ...
    pdf(paste0("../figures/atrisk-combo-split", outsuffix, ".pdf"), width=6, height=3.5)
...
if (do.figures) {
    ...
    pdf(paste0("../figures/export-value-split", outsuffix, ".pdf"), width=3.5, height=4)
    ...
    pdf(paste0("../figures/export-catch-split", outsuffix, ".pdf"), width=4, height=4)
    ...
    pdf(paste0("../figures/export-combo-split", outsuffix, ".pdf"), width=6, height=3.5)
...
if (do.figures) {
    ...
    if (do.drophighres)
        pdf(paste0("../figures/atrisk-portion-nohi-split", outsuffix, ".pdf"), width=8, height=5)
    else
        pdf(paste0("../figures/atrisk-portion-split", outsuffix, ".pdf"), width=8, height=5)
    ...
    if (do.drophighres) {
        pdf(paste0("../figures/atrisk-portion-nohi-100-split", outsuffix, ".pdf"), width=3.4, height=5)
        ...
        pdf(paste0("../figures/atrisk-portion-nohi-20-split", outsuffix, ".pdf"), width=3.4, height=5)
        ...
        pdf(paste0("../figures/atrisk-portion-nohi-5-split", outsuffix, ".pdf"), width=5, height=5)
        ...
        pdf(paste0("../figures/atrisk-portion-macros-split", outsuffix, ".pdf"), width=5, height=5)
        ...
        pdf(paste0("../figures/atrisk-portion-micros-split", outsuffix, ".pdf"), width=5, height=5)
