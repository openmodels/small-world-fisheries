    ...
    for (jj in 1:length(subregs)) {
        if (grepl(':', subregs[jj])) {
            ...
            for (kk in 1:length(minors)) {
                ...
                if (minors[kk] %in% c("87.2.3", "87.2.4", "87.1.22", "87.1.23", "87.1.24", "87.1.25", "87.2.22", "87.2.23", "87.2.24", "87.3.2", "41.3.3", "21.6.F", "21.6.G", "21.6.H", "27.V.a.1", "58.5.1")) # Not associated with any EEZ
                    next
...
write.csv(specieseez, "specieseez.csv", row.names=F)
